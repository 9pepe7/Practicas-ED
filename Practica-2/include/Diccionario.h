...
class Diccionario {
 ...
 private:
   ...
   Vector_Dinamico<Termino> dicc; /**< Vector dinamico de terminos */
 ...
 /**
  ...
  /**
    ...
    */
  Diccionario(Vector_Dinamico<Termino> vec);
...
/**
  ...
  * @param p String identificador del Termino cuya palabra coincide con p
...
/**
  ...
  * @param i Índice del termino del vector dinámico
...
/**
  ...
  * @param i Índice del Termino que se devuelve
...
/**
  ...
  * @param t El Termino a añadir al diccionario
  */
  void nuevoTermino(Termino t);

/**
  * @brief Busca un Termino en el diccionario
  * @param t Termino que buscar en el diccionario
...
/**
  ...
  * @param p Palabra que buscar en el diccionario
  * @return Devuelve el índice del vector de Terminos del
...
/**
  ...
  * @post El tamaño del vector de términos se reducirá en uno
  */
...
/**
  ...
  * @param ini Carácter inicial del límite del intervalo
  * @param fin Carácter final del límite del intervalo
...
/**
  ...
  * @param i Índice del vector de Terminos cuyo vector de definiciones va a ser ampliado
  * @param def Cadena de caracteres de la definición a añadir
...
/**
  ...
  * @param clave Cadena que buscar en los strings de definiciones del diccionario
...
/**
  ...
  * @param d Diccionario a sacar por el flujo
