...
bool comp::menor(const char& c1, const char& c2) const{ // return true si c1 es anterior alfabeticamente a c2
...
bool comp::operator() (const string& pal1, const string& pal2) const{
...
bool comp::operator() (const char& c1, const char& c2) const{
  return menor(c1,c2);
}
